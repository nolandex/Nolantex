// config/site.ts (SUDAH DIPERBARUI)
...
const baseSiteConfig = {
  ...
  // ----- BAGIAN INI SUDAH DIEDIT -----
  footerLinks: [
    { name: 'email', href: "mailto:bisnovohq@gmail.com", icon: MdEmail },
    { name: 'instagram', href: "https://www.instagram.com/bisnovo/", icon: FaInstagram },
    { name: 'tiktok', href: "https://www.tiktok.com/@bisnovo", icon: FaTiktok },
    { name: 'facebook', href: "https://www.facebook.com/bisnovo", icon: FaFacebook },
    // Link untuk Discord, Telegram, Twitter, dan Threads sudah dihapus.
  ],
  footerProducts: []
};
